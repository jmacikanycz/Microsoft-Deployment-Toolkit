...
::***** Install ABR Activation for Lenovo E440 & E450 *****
:STARTINSTALL
ECHO Installing ABR Activation for Lenovo E440 & E450. This box will close when installation is complete.
%systemroot%\XXXXX\ABRActivation\activation_restore.exe --silent
goto CREATELOG

::***** Create Log that ABR Activation for Lenovo E440 & E450 was installed so it won't try reinstalling *****
:CREATELOG
ECHO Installed ABR Activation for Lenovo E440 & E450 on %date% at %time% > %systemroot%\XXXXX\ABRActivation.txt
goto INSTALLED

::***** Notification that ABR Activation for Lenovo E440 & E450 was already installed - Calls ABRActivation_already_installed.vbs *****
:ALREADYINSTALLED
pushd %~dp0
xcopy ABRActivation_already_installed.vbs %systemroot%\XXXXX\ABRActivation\
popd
cls
ECHO ABR Activation for Lenovo E440 & E450 was already installed!
